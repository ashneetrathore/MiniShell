...
typedef struct list {
    node_t* head;
    int length;
    int (*comparator)(const void*, const void*); // the comparator uses the values of the nodes directly (i.e function has to be type aware)
    void (*printer)(void*, void*);  // function pointer for printing the data stored
    void (*deleter)(void*);         // function pointer for deleting any dynamically allocated items within the data stored
